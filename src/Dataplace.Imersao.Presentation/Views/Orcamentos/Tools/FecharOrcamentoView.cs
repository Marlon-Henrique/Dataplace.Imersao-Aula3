...
namespace Dataplace.Imersao.Presentation.Views.Orcamentos.Tools
{
    public partial class FecharOrcamentoView : dpLibrary05.Infrastructure.UserControls.ucSymGen_ToolDialog
    {
        ...
        private C1TrueDBGrid gridOrcamento;
        ...
        public FecharOrcamentoView()
        {
            ...
            _orcamentoList = new C1TrueDBGridListBehavior<OrcamentoViewModel, OrcamentoQuery>(gridFecharOrcamento)
            ...
            this.KeyDown += FecharOrcamentoView_KeyDown;
        ...
        {
            clsOffice.ExportTrueDbGridToExcel(gridFecharOrcamento, xlsOption.xlsSaveAndOpen);
        }
